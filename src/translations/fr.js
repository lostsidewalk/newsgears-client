...
// demo (feed dashboard)
  ...
  pleaseEnableNotifications: "Veuillez activer les notifications pour recevoir des messages de FeedGears.",
  // buttons 
  update: "Mettre à jour",
  save: "Enregistrer",
  // queue config panel 
  queueProperties: "Propriétés de la file d'attente",
  rssFeedDiscovery: "Découverte des flux RSS",
  ...
  queueTitleHint: "Un nom descriptif facultatif pour cette file d'attente. Cette valeur est affichée dans l'interface utilisateur de FeedGears pour faire référence à cette file d'attente.",
  ...
  queueFeedGenerator: "Générateur de flux",
  queueFeedGeneratorHint: "Dans les artefacts publiés pour cette file d'attente, cette valeur apparaît comme valeur de 'générateur de flux'.",
  queueFeedCopyright: "Droits d'auteur",
  queueFeedCopyrightHint: "Dans les artefacts publiés pour cette file d'attente, cette valeur apparaît comme valeur de 'droits d'auteur du flux'.",
  queueFeedLanguage: "Langue",
  queueFeedLanguageHint: "Dans les artefacts publiés pour cette file d'attente, cette valeur apparaît comme valeur de 'langue du flux'.",
  // subscription config
  ...
  error: "Erreur",
  updateAuth: "Mettre à jour les identifiants",
  ...
  feedGearsFilterSupports: 
    "La fonction de filtrage de FeedGears prend en charge une syntaxe permettant aux utilisateurs de créer des requêtes de recherche complexes. La syntaxe de base est la suivante :",
  ...
  hereAreSomeExamples: 
    "Voici quelques exemples de requêtes de recherche que vous pouvez effectuer en utilisant la fonction de filtrage de FeedGears :",
  ...
  inAdditionTo: 
    "En plus des requêtes champ:valeur de base, FeedGears prend en charge des options de recherche avancées telles que les recherches avec des caractères génériques, les recherches approximatives et les recherches par plage. Vous pouvez vous référer à la documentation de FeedGears pour plus de détails sur ces options de recherche avancées.",
  // help panel
  feedGearsHelp: "Aide de FeedGears",
  dismiss: "Ignorer",
  ...
  manageSubscriptions: "Gérer les abonnements ({ct})",
  subscriptions: "ABONNEMENTS",
  recentArticles: "ARTICLES RÉCENTS",
  zeroSubscriptions: "0 abonnement",
  ...
  queueDashboard: "TABLEAU DE BORD DES FLUX",
  ...
  goToFirstPost: "Aller au premier article",
  goToLastPost: "Aller au dernier article",
  ...
  usernameColon: "NOM D'UTILISATEUR :",
  ...
  themeSettingsUpdated: "Paramètres du thème mis à jour",
  opmlExportDownloaded: "Export OPML téléchargé",
  yourSubscriptionWasCanceledClickToResume:
    "Votre abonnement a été annulé. Pour le reprendre, cliquez sur 'Reprendre l'abonnement' sur cette page.",
  yourSubscriptionWasResumed: "Votre abonnement a été repris",
  subscriptionStatus:
    "Votre abonnement est actuellement {status}. Il a commencé le {started}.",
  // docs 
...
socialLogins: "Connexions sociales",
  ...
  goToSettingsAriaLabel: "Accéder aux paramètres du compte",
