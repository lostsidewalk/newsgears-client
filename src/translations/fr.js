...
// demo (feed dashboard)
  ...
  feedDashboard_detail2: "Par défaut, FeedGears affiche le nombre d'articles non lus, le nombre d'articles 'étoilés' et l'article le plus récemment publié ou mis à jour dans toutes les abonnements d'une file d'attente. La carte du tableau de bord permet également un accès rapide à la gestion des abonnements et fournit des informations générales sur chaque flux dans une file d'attente :",
  ...
  createANewQueueHere: "Créez une nouvelle file d'attente ici. Les files d'attente sont utilisées pour regrouper et organiser les articles des abonnements aux flux connexes. Les articles de la même file d'attente sont lus, indexés et filtrés ensemble. De même, les articles de la même file d'attente qui sont 'favoris' sont publiés dans un flux spécifique à la file d'attente, disponible dans plusieurs formats. Utilisez ce panneau pour créer une nouvelle file d'attente, définir ses propriétés de base et configurer les paramètres liés à la publication des articles favoris. Une fois une file d'attente créée, vous pouvez ajouter des abonnements pour importer des articles.",
  updateQueueSettings: "METTRE À JOUR LES PARAMÈTRES DE LA FILE D'ATTENTE",
  updateQueueSettingsHere: "Mettez à jour les paramètres de la file d'attente ici. Les files d'attente sont utilisées pour regrouper et organiser les articles des abonnements aux flux connexes. Les articles de la même file d'attente sont lus, indexés et filtrés ensemble. De même, les articles de la même file d'attente qui sont 'favoris' sont publiés dans un flux spécifique à la file d'attente, disponible dans plusieurs formats. Utilisez ce panneau pour modifier les propriétés de base de la file d'attente et configurer les paramètres liés à la publication des articles favoris.",
  ...
  starredFieldDesc: "Le statut d'étoile de l'article (true, false).",
  ...
  showStarred: "Afficher les favoris",
  ...
  starThisPost: "Mettre cet article en favori",
  unstarThisPost: "Retirer cet article des favoris",
