<template>
  <v-sheet>
    ...
    >
      <v-card-title class="pa-4">
        SUBSCRIBE TO KEEP THE LIGHTS ON <v-icon icon="fa-lightbulb-o" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        MOBILE OPTIMIZATION <v-icon icon="fa-mobile" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        GPT-BASE RECOMMENDATION ENGINE <v-icon icon="fa-android" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        SOCIAL MEDIA INTEGRATION <v-icon icon="fa-share-square" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        SMART SORTING AND FILTERING <v-icon icon="fa-filter" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        TOOLS INTEGRATION <v-icon icon="fa-wrench" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
        To help you streamline your workflow, FeedGears integrates with a variety of productivity tools such as:
        <v-chip-group class="mt-2">
          <v-chip
            label
            append-icon="fa-external-link"
            size="large"
            elevation="2"
            variant="outlined"
          >
    ...
    >
      <v-card-title class="pa-4">
        CUSTOMIZATION <v-icon icon="fa-sliders" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        ADVANCED SEARCH <v-icon icon="fa-search" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
    ...
    >
      <v-card-title class="pa-4">
        READ-IT-LATER <v-icon icon="fa-archive" />
      </v-card-title>
      <v-divider />
      <v-card-text align="left">
