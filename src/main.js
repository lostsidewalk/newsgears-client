...
const i18n = createI18n({
  ...
  messages: {
    es: {
      ...
      rssAtomFeeds: 'Fuentes RSS/ATOM',
      iTunesPodcasts: 'Podcasts de iTunes',
      youtube: 'YouTube',
      reddit: 'Reddit',
      ...
      queueIdentifierTooLong: 'El identificador de cola es demasiado largo (máximo 2048 caracteres).',
      queueTitleTooLong: 'El título de la cola es demasiado largo (2048 caracteres como máximo).',
      feedGeneratorTooLong: 'El generador es demasiado largo (máximo 2048 caracteres).',
      feedURLTooLong: 'La URL de la fuente RSS es demasiado larga (máximo 2048 caracteres).',
