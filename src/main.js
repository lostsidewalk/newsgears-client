  ...
  messages: {
    es: {
      ...
      somethingHorribleHappened:
        "¡Algo horrible sucedió, y no estamos seguros de qué! Vuelva a intentarlo en unos momentos.",
      requestTimedOut:
        "Se agotó el tiempo de espera de la solicitud. Vuelva a intentarlo en unos momentos.",
      ...
      subscribed: "¡Suscrito!",
      inDevelopment:
        "Lo sentimos, esta sección de FeedGears aún no está lista. ¡Vuelve a consultar en unos días!",
      // auth
      loginToFeedGears: "Ingrese a FeedGears",
      ...
      unableToCompleteYourRequest:
        "No pudimos completar su solicitud. Intente iniciar sesión con otro método.",
      ...
      pwResetRequestMessage:
        "Ingresa tu nombre de usuario y tu dirección de correo electrónico. Le enviaremos un enlace de restablecimiento de contraseña a su dirección de correo electrónico verificada.",
      ...
      registrationRequirements:
        "Se requiere nombre de usuario, dirección de correo electrónico y contraseña para registrarse.",
      // landing
      ...
      contactUsWithQuestionsViaEmail:
        "Comuníquese con Lost Sidewalk Software si tiene preguntas por correo electrónico",
      // faq
